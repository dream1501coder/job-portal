...
urlpatterns = [
    ...
    path('bidding_rate/<str:id>/<str:end_time>', views.bidding_rate,name="bidding_rate"),
    path('bidding_rate/<str:id>', views.bidding_rate,name="bidding_rate"),

    path('bidding_starting_progress/<int:id>/<str:end_time>', views.bidding_starting_progress,name="bidding_starting_progress"),
    path('bidding_intermediate_progress/<int:id>/<str:end_time>', views.bidding_intermediate_progress,name="bidding_intermediate_progress"),
    path('bidding_mediate_progress/<int:id>/<str:end_time>', views.bidding_mediate_progress,name="bidding_mediate_progress"),
    path('bidding_finished_progress/<int:id>/<str:end_time>', views.bidding_finished_progress,name="bidding_finished_progress"),
    path('bidding_completed_progress/<int:id>/<str:end_time>', views.bidding_completed_progress,name="bidding_completed_progress"),
